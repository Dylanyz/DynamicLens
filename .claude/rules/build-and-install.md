...
| Build "fails" with exit 255 and no error | output piped through `Select-Object -First N`, which stops the script mid-package | redirect to a log (`*> $env:TEMP\dlb_build.log`) and `Select-String` it afterwards |
